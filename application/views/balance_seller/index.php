...
<div class="container-fluid">
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <table class="table table-hover" id="table" data-url="<?= base_url('balance_seller/get_list') ?>">
                    <thead>
                        <tr>
...
<div class="modal fade" id="acceptModal" tabindex="-1" role="dialog" aria-labelledby="acceptModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('balance_seller/accepted') ?>" method="post" id="form_accepted" onsubmit="accept(event, this)">
